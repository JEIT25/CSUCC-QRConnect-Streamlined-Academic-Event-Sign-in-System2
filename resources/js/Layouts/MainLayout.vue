...
<!-- <link href="https://fonts.googleapis.com/css2?family=Hubballi&display=swap" rel="stylesheet"> -->
    ...
    <div class="flex">
        <!-- Sidebar -->
           ...
           <aside class="w-64 bg-slate-950 p-4 h-screen shadow-lg shadow-yellow-500 hidden lg:block"> <!-- Hidden on mobile, visible on large screens -->
    ...
    <div class="flex flex-col items-center ml-2 mt-9 mb-7">
        ...
        <div class="text-yellow-300 text-center">
            <p class="font-hubballi font-semibold pt-2 text-white">{{ page.props.user.fname }} {{ page.props.user.lname }}</p>
            <p class="text-xs uppercase">{{ page.props.user.type }}</p>
        </div>
    </div>

    <!-- Add spacing for modules -->
    <div class="mb-[20%]"></div> <!-- Adjusted spacing to 5% -->
                            ...
                            <ul class="flex space-x-8">
                                <li v-if="page.props.user">
                                    <!-- <Link class="text-yellow-400 hover:text-yellow-200" href="#">
                                        {{ page.props.user.type }} {{ page.props.user.fname }} {{ page.props.user.lname }}
                                    </Link> -->
