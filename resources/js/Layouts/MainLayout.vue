<template>
    ...
    <ul class="flex flex-col w-full space-y-2"> <!-- Add space between items -->
        <li class="flex items-center w-full bg-slate-800 hover:bg-slate-700 rounded-md transition duration-200 ease-in-out p-4"> <!-- Increased padding and background -->
